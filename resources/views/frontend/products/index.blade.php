                        ...
                        <div class="col-sm-6">
                            ...
                            <div id="product">
                                ...
                                <div class="cart">
                                    <div>
                                        @if($product->status == 1 && $product->stock > 0)
                                            <a href="{{route('basket.add', ['id' => $product->id])}}" id="button-cart"  class="btn btn-primary btn-lg">افزودن به سبد</a>
                                        @else
                        ...
                        @foreach($relatedProducts as $product)
                            <div class="product-thumb clearfix">
                                ...
                                <div class="button-group">
                                    <a class="btn-primary" href="{{route('basket.add', ['id' => $product->id])}}" ><span>افزودن به سبد</span></a>
                                </div>
                            </div>
                        @endforeach
                    </div>
