        ...
        <div id="content" class="col-sm-9">
            ...
            <div class="row">
                {{--<div class="col-sm-6">--}}
                    ...
                    {{--<a href="{{url('register')}}" class="btn btn-primary">ادامه</a>--}}
                {{--</div>--}}
                <div class="col-sm-12">
                    <h2 class="subtitle">ورود مدیران</h2>
                    ...
                    <form method="post" action="{{route('admin.login.submit')}}">
                        ...
                        <div id="forget-password" class="form-group">
                            ...
                            <br />
                            <a  href="{{route('admin.password.request')}}">فراموشی رمز عبور</a></div>
